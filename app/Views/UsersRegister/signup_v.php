...
<form action="/UsersRegister/signup" method="POST" enctype="multipart/form-data">
    <p>프로필 사진</p>
    ...
    <p>나이 : <input type="number" name="author[age]" value="<?= !empty($author['age']) ? $author['age'] : null ?>"></p>
    <p>성별 : 
