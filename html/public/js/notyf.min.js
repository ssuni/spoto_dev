var Notyf = function () {
    ...
    var e, t, o = function () {
            return (o = Object.assign || function (t) {
                for (var i, n = 1, e = arguments.length; n < e; n++)
                    for (var o in i = arguments[n]) Object.prototype.hasOwnProperty.call(i, o) && (t[o] = i[o]);
                return t
    ...
    var r = {
        ...
        c = (p.prototype.on = function (t, i) {
            ...
            var i, n = this._buildNotificationCard(t),
            ...
            if (a.appendChild(r), o.appendChild(a), c && (t.ripple ? (s.style.background = c, o.appendChild(s)) : o.style.background = c), t.dismissible) {
                ...
                l.appendChild(f), a.appendChild(l), o.classList.add("notyf__toast--dismissible"), f.addEventListener("click", function () {
                    var t;
                    return null === (t = n.events) || void 0 === t ? void 0 : t[m.Dismiss](i)
                })
            }
            var u = "top" === this.getYPosition(t) ? "upper" : "lower";
            return o.classList.add("notyf__toast--" + u), o
            ...
            t.setAttribute("aria-atomic", "true"), t.setAttribute("aria-live", "polite"), t.style.border = "0", t.style.clip = "rect(0 0 0 0)", t.style.height = "1px", t.style.margin = "-1px", t.style.overflow = "hidden", t.style.padding = "0", t.style.position = "absolute", t.style.width = "1px", t.style.outline = "0", document.getElementById('listTitle').appendChild(t), this.a11yContainer = t
    ...
    function p() {
        ...
        t.appendChild(i), document.getElementById('listTitle').appendChild(t), this.container = i, this.animationEndEventName = this._getAnimationEndEventName(), this._createA11yContainer()
    }
    ...
    return d.prototype.error = function (t) {
        ...
        return r.types.map(function (i) {
            var t = e.findIndex(function (t) {
                    return t.type === i.type
                }),
                n = -1 !== t ? e.splice(t, 1)[0] : {};
            return o(o({}, i), n)
        }).concat(e)
    }, d
}();