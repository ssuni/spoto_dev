                ...
                for (var i = 1; i <= _matchcount; i++) {
                    try {
                        ...
                        if (progress == "1") {
                            ...
                            var img_node = '<img src="https://spoto.com/img/in.gif">';
                            var last = '45+';
                            var start = '1';
        ...
        return {
            connect_io: function () {
                ...
                _socket.on("connect", function (res) {
                    ...
                    //         //localStorage.removeItem('analysis_team_idx'); // localstorage 삭제 이벤트
                    //     }
                    //     // $DOCUMENT.keydown(function (e) { // 분석페이지 팝업창 새로고침 방지 이벤트
                    //     //     if (e.which === 116) {
...
console.log(title_data);
                ...
                if(home_img == null){
                    html += '<div><img src="'+(DOMAIN+NO_IMG)+'"></div>';
                }else {
                    html += '<div><img src="' + home_img + '"></div>';
                }
                html += '<div>';
                html += '<div>' + home_name + '</div>';
                    ...
                    for (var c = 0; c < recent_home.length; c++) {
                        ...
                        if (recent_home[c].home_goal > recent_home[c].away_goal) {
                            if(recent_home[c].home_img == null) {
                                html += '<div class="win_team" data-home_idx="' + recent_home[c].home_team_idx + '">' + recent_home[c].home_name + '<img src="'+(DOMAIN+NO_IMG)+'"></div>';
                            }else {
                                html += '<div class="win_team" data-home_idx="' + recent_home[c].home_team_idx + '">' + recent_home[c].home_name + '<img src="' + recent_home[c].home_img + '"></div>';
                            }
                        } else {
                            if(recent_home[c].home_img == null){
                                html += '<div data-home_idx="' + recent_home[c].home_team_idx + '">' + recent_home[c].home_name + '<img src="'+(DOMAIN+NO_IMG)+'"></div>';
                            }else {
                                html += '<div data-home_idx="' + recent_home[c].home_team_idx + '">' + recent_home[c].home_name + '<img src="' + recent_home[c].home_img + '"></div>';
                            }
                        }
                        ...
                        if (recent_home[c].home_goal < recent_home[c].away_goal) {
                            if(recent_home[c].away_img == null){
                                html += '<div class="win_team" data-away_idx="' + recent_home[c].away_team_idx + '"><img src="' + (DOMAIN+NO_IMG) + '">' + recent_home[c].away_name + '</div>';
                            }else {
                                html += '<div class="win_team" data-away_idx="' + recent_home[c].away_team_idx + '"><img src="' + recent_home[c].away_img + '">' + recent_home[c].away_name + '</div>';
                            }
                        } else {
                            if(recent_home[c].away_img == null){
                                html += '<div data-away_idx="' + recent_home[c].away_team_idx + '"><img src="' + (DOMAIN+NO_IMG) + '">' + recent_home[c].away_name + '</div>';
                            }else {
                                html += '<div data-away_idx="' + recent_home[c].away_team_idx + '"><img src="' + recent_home[c].away_img + '">' + recent_home[c].away_name + '</div>';
                            }
                        }
                ...
                if(opp_data == null){
                    ...
                    for (var i = 0; i < loop_length; i++) {
                        ...
                        if (opp_home_list[i].home_goal < opp_home_list[i].away_goal) {
                            if(home_team_idx == opp_home_list[i].home_idx) {
                                html += '<div class="win_team" data-away_idx="' + opp_home_list[i].away_idx + '"><img src="' + away_img + '">' + opp_home_list[i].away_name + '</div>';
                            }else {
                                html += '<div class="win_team" data-away_idx="' + opp_home_list[i].away_idx + '"><img src="' + home_img + '">' + opp_home_list[i].away_name + '</div>';
                            }
                        } else {
                            if(home_team_idx != opp_home_list[i].home_idx) {
                                html += '<div data-away_idx="' + opp_home_list[i].away_idx + '"><img src="' + home_img + '">' + opp_home_list[i].away_name + '</div>';
                            }else{
                                html += '<div data-away_idx="' + opp_home_list[i].away_idx + '"><img src="' + away_img + '">' + opp_home_list[i].away_name + '</div>';
                            }
                        }
                        html += '<div>|</div>';
                    ...
                    for (var n = 0; n < opp_content_name.length; n++) {
                        ...
                        if (opp_val_arr[0][n] != 0 && opp_val_arr[1][n] != 0) {
