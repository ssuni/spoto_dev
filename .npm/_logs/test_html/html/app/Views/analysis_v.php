...
<!--        </div>-->
    ...
    if($trend_point_a['point_avg_diff'] !== 0) {
    ...
    <section id="line_up">
            ...
            <div class="main_content">
                <div>
                    ...
                    <div class="content_box">
                        <div class="team_title">
                            <div style="border-top: 1px solid #517dc9;">홈팀명</div>
                            <div style="border-top: 1px solid #ffd46e;">원정팀명</div>
                        </div>
                        <div class="second_sub_title">
                            <div>3 - 4 - 3</div>
                            <div>포메이션</div>
                ...
                <div>
                    ...
                    <div class="content_box">
                        ...
                        <div class="content_result">
                            <div>3승 1무 1패 - 경기당 평균 득점 : 3.12  /  평균 실점 : 2.47</div>
                            <div class="graph">
                                <div class="pie_graph">
                                    <div style="width: 312px; height:198px;">
                                        <canvas id="h_formation_pie"></canvas>
                                    </div>
                                </div>
                                <div class="d_line_graph">
                                    <div style="width: 592px; height:198px;">
                                        <canvas id="h_formation_d_line"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content_box">
                        ...
                        <div class="content_result">
                            <div>1승 2무 2패 - 경기당 평균 득점 : 2.28  /  평균 실점 : 3.37</div>
                            <div class="graph">
                                <div class="pie_graph">
                                    <div style="width: 312px; height:198px;">
                                        <canvas id="a_formation_pie"></canvas>
                                    </div>
                                </div>
                                <div class="d_line_graph">
                                    <div style="width: 592px; height:198px;">
                                        <canvas id="a_formation_d_line"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
